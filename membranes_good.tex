...
\begin{equation}\label{eq:8}
	\mathcal{H} = \int dS (\kappa/2 (2H-C_0)^2+\kappa_G K_G)
\end{equation}
...
For small deformations of a bilayer of zero spontaneous curvature ($C_0=0$), the first term of the integral is often presented in terms of the Monge gauge \cite{Safran1994}:

\begin{equation}\label{eq:9}
	\mathcal{H} = \int dxdy (\kappa/2 (\nabla^2 h(x,y))^2)
\end{equation}
...
The time scale of study can vary significantly with different methods; for example, EPR and NMR measure motions over distances and time scales around > 0.1 m and ns-ms, much longer than quasi-elastic neutron scattering at 0.1-10 nm and < 1 ns \cite{Poger2016}.
